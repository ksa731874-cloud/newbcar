        ...
        <div class="shadow-sm bg-white" style="border-radius: 15px;">
            <form action="" method="POST">
                ...
                <div class="mt-3 px-3">
                    ...
                    <input type="date" id="date" name="date" readonly required inputmode="numeric"
                        class="form-control fw-bold text-center text-primary">

                    <label for="" class="mb-2 mt-3"> تاريخ نهاية التغطية</label>
                    <input type="date" id="date2" name="date2" readonly required inputmode="numeric"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center border-0 shadow-lg" style="border-radius: 24px;">
                <div class="modal-header-error p-5" style="background: #fff5f5;">
                    ...
                    <p class="text-muted small px-3">البيانات المدخلة غير صحيحة، يرجى التأكد من رقم الهوية أو التواريخ والمحاولة مرة أخرى.</p>
